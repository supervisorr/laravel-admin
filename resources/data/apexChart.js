...
export const lineColumAreaTest = {
...
//  *
//  */
// export const dataAreaByHoursOfDay = {
//
//     chartOptions: {
//         series: [{
//             name: 'Nº usuarios',
//             type: 'column',
//             data: [0,0,0,0,0,0,0,0,2,3,2,0,0,0,0,2,7,4,0,0,0,0,0,0],
//         }, {
//             name: 'Nº usuarios',
//             type: 'area',
//             data: [0,0,0,0,0,0,0,0,2,3,2,0,0,0,0,2,7,4,0,0,0,0,0,0],
...
//         },
//         title: {
//             text: 'Total usuarios activos de User-ATC por hora del dia'
//         },
//         dataLabels: {
//             enabled: true,
//             enabledOnSeries: [1]
...
//             labels: {
//                 style: {
//                     colors: ["#E91E63","#E91E63","#E91E63","#E91E63","#E91E63","#E91E63","#E91E63","#E91E63","#E91E63","#E91E63","#E91E63","#E91E63","#E91E63","#E91E63","#E91E63","#E91E63","#E91E63","#E91E63","#E91E63","#E91E63","#E91E63","#E91E63","#E91E63","#E91E63"],
//                 }
//             }
//         },
//         yaxis: [{
...
export const dataAreaByHoursOfDayAll = {
    series: [{
        name: 'Nº usuarios',
        type: 'column',
        data: [1, 0, 0, 0, 0, 1, 0, 0, 11, 8, 6, 2, 4, 2, 1, 2, 9, 8, 0, 2, 1, 5, 4, 1],
    }, {
        name: 'Nº usuarios',
        type: 'area',
        data: [1, 0, 0, 0, 0, 1, 0, 0, 11, 8, 6, 2, 4, 2, 1, 2, 9, 8, 0, 2, 1, 5, 4, 1],
    ...
    chartOptions: {
        ...
        title: {
            text: 'Total usuarios activos de todos los clientes por hora del dia'
        },
        dataLabels: {
            enabled: true,
            enabledOnSeries: [1]
...
export const dataBarByDayOfWeek = {
    series: [{
        name: 'Nº usuarios',
        data: [4, 0, 2, 4, 10, 0, 0]
    }],
    chartOptions: {
        ...
        colors: ["#2E93fA", "#2E93fA", "#2E93fA", "#2E93fA", "#2E93fA", "#2E93fA", "#2E93fA"],
        plotOptions: {
            bar: {
                columnWidth: '45%',
                distributed: true,
        ...
        title: {
            text: 'Total usuarios activos de User-ATC por día de la semana'
        },
        xaxis: {
            categories: [23, 23, 23, 23, 23, 23, 23],
            labels: {
                style: {
                    colors: ["#2E93fA", "#2E93fA", "#2E93fA", "#2E93fA", "#2E93fA", "#2E93fA", "#2E93fA"],
                    fontSize: '12px'
...
export const dataBarByDayOfWeekAll = {
    series: [{
        name: 'Nº usuarios',
        data: [21, 1, 4, 16, 17, 8, 1]
    }],
    chartOptions: {
        legend: {
            show: false,
        ...
        title: {
            text: 'Total usuarios activos de todos los clientes por día de la semana'
        },
        xaxis: {
...
export const dataBarByBrowser = {
    series: [{
        name: 'Porcentaje',
        data: [0, 0, 0, 0, 6.25, 6.25, 87.5]
    }],
    chartOptions: {
        chart: {
            type: 'bar',
...
//             },
        ...
        xaxis: {
            // position: 'top',
            categories: ["Edge", "Firefox", "Internet Explorer", "Opera", "Chrome", "Safari", "Other (Unknown)"],
            max: 100,
        },
        title: {
            text: 'Uso navegadores de User-ATC'
        },
        yaxis: {
            axisBorder: {
                // show: false
...
export const dataBarByBrowserAll = {
    series: [{
        name: 'Porcentaje',
        data: [0.29, 0.29, 0.58, 1.3, 1.59, 2.17, 93.78]
    }],
    chartOptions: {
        chart: {
            type: 'bar',
...
//             },
        ...
        title: {
            text: 'Uso navegadores de todos los clientes'
        },
        yaxis: {
            axisBorder: {
                // show: false
...
export const dataPieByResolution = {
    series: [93.75, 0, 0, 6.25, 0],
    chartOptions: {
        legend: {
            show: true,
            position: 'right',
        ...
        labels: ["Other (Unknown)", "600x400", "900x600", "1900x1024", "1200x900"],
        title: {
            text: 'Resoluciones pantalla de User-ATC'
        },
        responsive: [{
            breakpoint: 480,
            options: {
...
export const dataPieByResolutionAll = {
    series: [98.41, 0.14, 0.72, 0.29, 0.43],
    chartOptions: {
        legend: {
            show: true,
        },
        ...
        labels: ["Other (Unknown)", "600x400", "900x600", "1900x1024", "1200x900"],
        title: {
            text: 'Resoluciones pantalla de todos los clientes'
        },
        responsive: [{
            breakpoint: 480,
            options: {
...
export const dataPieBySo = {
    series: [87.5, 0, 6.25, 0, 6.25, 0, 0],
    chartOptions: {
        legend: {
            show: true,
            position: 'right',
        ...
        labels: ["Other (Unknown)", "Windows 7", "Linux", "Windows 10", "Mac OS X", "Android", "Windows Vista"],
        title: {
            text: 'Sistemas opertivos de User-ATC'
        },
        responsive: [{
            breakpoint: 480,
            options: {
...
export const dataPieBySoAll = {
    series: [93.78, 0.72, 0.87, 0.29, 3.91, 0.29, 0.14],
    chartOptions: {
        legend: {
            show: true,
        },
        ...
        labels: ["Other (Unknown)", "Windows 7", "Linux", "Windows 10", "Mac OS X", "Android", "Windows Vista"],
        title: {
            text: 'Sistemas opertivos de todos los clientes'
        },
        responsive: [{
            breakpoint: 480,
            options: {
